...
public class Create extends BasicFrame
{
	...
	public void addMainSection()
	{
		...
		main_section.setLayout(new BoxLayout(main_section,BoxLayout.Y_AXIS));
				...
				main_heading_panel.setLayout(new FlowLayout(FlowLayout.CENTER,0,20));
					JTextField main_heading=new JTextField("INSERT DATA");
				...
				main_para_panel.setLayout(new BoxLayout(main_para_panel,BoxLayout.Y_AXIS));
					...
					button_panel.setLayout(new FlowLayout(FlowLayout.CENTER,10,0));
						JButton main_button=new JButton("Add Student");
							...
							main_button.addActionListener(new ActionListener()
									{
										public void actionPerformed(ActionEvent e)
										{
											...
											if(StudentOperations.addStudent(rollno, name, deg, marks))
											{
												JOptionPane.showMessageDialog(main_section,"Student Added Successfully!");
												new Create();
												dispose();
											}
											else
											{
												JOptionPane.showMessageDialog(main_section,"Couldn't add this student! (Maybe the student has already been added.)");
											}
										}
									});
